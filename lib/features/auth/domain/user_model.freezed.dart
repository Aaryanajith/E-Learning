...
class _$UserImpl implements _User {
  _$UserImpl({required this.token, required this.username});
  ...
  @override
  String toString() {
    return 'AppUser(token: $token, username: $username)';
  }
...
abstract class _User implements AppUser {
  factory _User({required final String token, required final String username}) =
      _$UserImpl;
